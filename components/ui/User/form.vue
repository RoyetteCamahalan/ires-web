<template>
  <div>
    <form method="POST" @submit.prevent="submitForm">
      <div class="p-6">
          ...
          <div class="grid grid-cols-6 gap-4">
            <div class="col-span-6 sm:col-span-3">
              ...
              <FormError
                :error="
                  v$.user.firstname &&
                  v$.user.firstname.$errors &&
                  v$.user.firstname.$errors.length > 0
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <FormError
                :error="
                  v$.user.lastname &&
                  v$.user.lastname.$errors &&
                  v$.user.lastname.$errors.length > 0
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <FormError
                :error="
                  v$.user.gender &&
                  v$.user.gender.$errors &&
                  v$.user.gender.$errors.length > 0
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <FormTextField
                ...
                v-model="state.user.designation"
              />
              <FormError
                :error="
                  v$.user.designation &&
                  v$.user.designation.$errors &&
                  v$.user.designation.$errors.length > 0
                    ? v$.user.designation.$errors[0].$message
                    : null
                "
              />
            </div>
        ...
        <div v-else>
          <div class="flex justify-between mb-2">
            ...
            <div class="flex flex-row-reverse flex-1">
              <FormSwitch
                :value="state.user.isappsysadmin"
                @toggleSwitch="
                  state.user.isappsysadmin = !state.user.isappsysadmin
                "
              />
          ...
          <div class="w-full">
            <div class="grid grid-cols-6 gap-4">
              <div class="col-span-6 sm:col-span-3">
                ...
                <FormError
                  :error="
                    vaccount$.user.email &&
                    vaccount$.user.email.$errors &&
                    vaccount$.user.email.$errors.length > 0
                      ? vaccount$.user.email.$errors[0].$message
                      : null
                  "
                />
              </div>
              <div class="col-span-6 sm:col-span-3">
                ...
                <FormError
                  :error="
                    ...
                    vaccount$.user.username.$errors &&
                    vaccount$.user.username.$errors.length > 0
                      ? vaccount$.user.username.$errors[0].$message
                      : null
                  "
                />
              </div>
            ...
            <div v-if="!formStatusEdit">
              ...
              <FormPasswordField
                ...
                v-model="state.user.userpass"
                :disabled="formStatusEdit"
              />
              <FormError
                :error="
                  vaccount$.user.userpass &&
                  vaccount$.user.userpass.$errors &&
                  vaccount$.user.userpass.$errors.length > 0
                    ? vaccount$.user.userpass.$errors[0].$message
                    : null
                "
              />
              ...
              <FormError
                :error="
                  vaccount$.user.confirmpassword &&
                  vaccount$.user.confirmpassword.$errors &&
                  vaccount$.user.confirmpassword.$errors.length > 0
                    ? vaccount$.user.confirmpassword.$errors[0].$message
                    : null
                "
              />
              <FormError
      ...
      <div
        class="px-6 py-3 flex justify-between rounded-b border-t border-gray-200"
      >
        <div>
          <FormButton
            type="button"
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const setPage = (value) => {
      if (value === 2) {
        v$.value.$validate();
        if (!v$.value.$error) state.page = value;
    ...
    const submitForm = async () => {
      ...
      if (!(v$.value.$error || vaccount$.value.$error)) {
        try {
          if (props.formStatusEdit) await employeeService.update(state.user);
          else await employeeService.create(state.user);
