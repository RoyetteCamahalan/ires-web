            ...
            >
              <div>
                ...
                <FormError
                  :error="
                    v$.user.userpass &&
                    v$.user.userpass.$errors &&
                    v$.user.userpass.$errors.length > 0
                      ? v$.user.userpass.$errors[0].$message
                      : null
                  "
                />
              </div>
              <div>
                ...
                <FormPasswordField
                  ...
                  v-model="state.user.newuserpass"
                ></FormPasswordField>
                <FormError
                  :error="
                    v$.user.newuserpass &&
                    v$.user.newuserpass.$errors &&
                    v$.user.newuserpass.$errors.length > 0
                      ? v$.user.newuserpass.$errors[0].$message
                      : null
                  "
                />
              </div>
              <div>
                ...
                <FormPasswordField
                  ...
                  v-model="state.user.confirmnewpassword"
                ></FormPasswordField>
                <FormError
                  :error="
                    v$.user.confirmnewpassword &&
                    v$.user.confirmnewpassword.$errors &&
                    v$.user.confirmnewpassword.$errors.length > 0
                      ? v$.user.confirmnewpassword.$errors[0].$message
                      : null
                  "
                />
              </div>
