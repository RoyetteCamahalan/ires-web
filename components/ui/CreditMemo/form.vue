      ...
      <div class="mx-4 mt-2">
        ...
        <div class="grid grid-cols-8 gap-2 p-3 mb-3 rounded-lg bg-white border">
          ...
          <div class="col-span-8 sm:col-span-2">
            ...
            <FormSelectCmtypes
              v-model="state.payment.creditmemotypeid"
            ></FormSelectCmtypes>
            <FormError
              :error="
                v$.payment.creditmemotypeid &&
                v$.payment.creditmemotypeid.$errors &&
                v$.payment.creditmemotypeid.$errors.length > 0
                  ? v$.payment.creditmemotypeid.$errors[0].$message
                  : null
              "
            />
          </div>
