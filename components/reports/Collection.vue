          ...
          <div class="w-full overflow-x-auto">
            ...
            >
              <template
                ...
                v-if="
                  !(
                    state.isPageLoading ||
                    (state.data.payments && state.data.payments.length === 0)
                  )
                "
              >
                <tr
                  v-for="(data, index) in state.data.payments"
                  :key="index"
                  class="text-gray-700"
                >
                  <td class="px-4 py-3">
            ...
            <div class="grid grid-cols-12 gap-4 pb-4">
              <div class="col-span-6 p-2 rounded-lg border">
                ...
                <div
                  class="flex justify-between mx-2 text-sm mt-2 pt-2 border-t font-semibold"
                >
                  <p>Total</p>
