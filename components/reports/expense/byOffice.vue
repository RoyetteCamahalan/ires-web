  ...
  <div>
    <LoadingSpinner :isActive="state.isPageLoading">
      ...
      >
        ...
        <div class="mt-2 text-lg font-semibold text-center">Expense Report</div>
        <div class="mt-1 text-sm text-center">
          From: {{ moment(startDate).format("MM/DD/YYYY") }} To:
            ...
            >
              ...
              >
                <template v-for="(group, i) in state.data" :key="i">
                  ...
                  <tr
                    v-for="(data, index) in group.data"
                    :key="index"
                    class="text-gray-700"
                  >
...
function groupData(data) {
  ...
  data.expenses.forEach((item) => {
    var objIndex = group.findIndex((obj) => obj.accountid === item.accountid);
    if (objIndex >= 0) {
