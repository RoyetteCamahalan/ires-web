<template>
    <div>
        <NuxtLayout name="admin" title="Lot Models">
            ...
            <div class="shadow-sm sm:rounded-lg my-2 mx-4 bg-white px-2 py-4 sm:px-6">
                <div class="mt-4">
                    <nav class="-mb-px flex space-x-6">
                        <a :href="`/projects/${uuid}`" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 border-b-2 px-8 pb-4 text-sm font-medium whitespace-nowrap">Lots</a>
                        <a :href="`/projects/${uuid}/models`" class="border-indigo-500 text-indigo-600 border-b-2 px-4 pb-4 text-sm font-medium whitespace-nowrap" aria-current="page">Type/Model</a>
                    </nav>
                </div>
