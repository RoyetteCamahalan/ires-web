    ...
    <div class="h-screen bg-gray-50 pt-4">
      <div class="max-w-screen-xl p-8 mx-auto bg-white rounded-xl shadow-xl">
        ...
        <p class="mt-4 text-sm text-justify">
          This privacy notice for HexaByt Software Development Service ("<span
            class="font-semibold"
            >Company</span
          >," "<span class="font-semibold">we</span>," "<span
            class="font-semibold"
            >us</span
          >," "<span class="font-semibold">our</span>"), describes how and why
          ...
          <span class="text-blue-700">info@hexabyt.com</span>.
        </p>
        ...
        <div>
          ...
          <h1 class="mt-4 font-semibold italic">
            In Short:
        ...
        <div>
          <h1 class="mt-4 font-semibold italic">
            ...
            <span class="font-normal"
              ...
              information for other purposes with your consent.</span
            >
          </h1>
          <p class="mt-4 text-sm text-justify">
        ...
        <div>
          <h1 class="mt-4 font-semibold italic">
            ...
            <span class="font-normal"
              ...
              section and/or with the following third parties.</span
            >
          </h1>
          <p class="mt-4 text-sm text-justify">
          ...
          <ul class="mt-2 ml-6 text-sm">
            ...
            <li class="mt-2">
              - <span class="font-semibold">Business Partners.</span>
        ...
        <h1 class="mt-6 text-xl font-semibold">4. DO WE USE COOKIES?</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
            We use cookies to access or store information. We store in cookies
            mostly to improve user experience.
          </p>
        </div>
        ...
        <div>
          <h1 class="mt-4 font-semibold italic">
            ...
            <span class="font-normal"
              ...
              other than your own.</span
            >
          </h1>
          <p class="mt-4 text-sm text-justify">
            Our servers are hosted in the United States. If you are accessing
            our Services from outside, please be aware that your information may
            be transferred to, stored, and processed by us in our hosting
            facility and by those third parties with whom we may share your
            personal information (see "WHEN AND WITH WHOM DO WE SHARE YOUR
            PERSONALINFORMATION?" above), in and other countries.
          </p>
          <p class="mt-4 text-sm text-justify">
        ...
        <div>
          ...
          <p class="mt-4 text-sm text-justify">
            <span class="font-semibold">Withdrawing your consent:</span>
            If we are relying on your consent to process your personal
            information, which may be express and/or implied consent depending
            onthe applicable law, you have the right to withdraw your consent at
            any time. You canwithdraw your consent at any time by contacting us
          ...
          <h1 class="mt-4 text-lg font-semibold">Account Information</h1>
          <p class="mt-4 text-sm text-justify">
            If you would at any time like to review or change the information in
            your account orterminate your account, you can contact us at
            <span class="text-blue-700">info@hexabyt.com</span>.
          </p>
          <p class="mt-4 text-sm text-justify">
        ...
        <div>
          <p class="mt-4 text-sm text-justify">
            ...
            future, we will inform you about that practice in a revisedversion
        ...
        <div>
          ...
          <p class="mt-4 text-sm text-justify">
            ...
            updated version will be effective assoon as it is accessible. If we
            make material changes to this privacy notice, we may notify you
            either by prominently posting a notice of such changes or by
            directly sending you a notification. We encourage you to review this
            privacy notice frequentlyto be informed of how we are protect ing
            your information.
          </p>
        </div>
        ...
        <div>
          <p class="mt-4 text-sm text-justify">
            ...
            us at <span class="text-blue-700">info@hexabyt.com</span>.
          </p>
        </div>
      </div>
    </div>
