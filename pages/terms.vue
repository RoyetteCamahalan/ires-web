<template>
  <div>
    <LandingHeader :hide-menu="true"></LandingHeader>
    <div class="h-screen bg-gray-50 pt-4">
      <div class="max-w-screen-xl p-8 mx-auto bg-white rounded-xl shadow-xl">
        <h1 class="text-xl font-semibold">TERMS AND CONDITIONS</h1>
        <h4 class="mt-4 text-sm font-semibold">Last updated May, 24, 2023</h4>
        <p class="mt-4 text-xl font-semibold">AGREEMENT TO OUR LEGAL TERMS</p>
        <p class="mt-4 text-sm text-justify">
          We are HexaByt Software Development Service, doing business as HexaByt
          ("<span class="font-semibold">Company</span>," "<span
            class="font-semibold"
            >we</span
          >," "<span class="font-semibold">us</span>," "<span
            class="font-semibold"
            >our</span
          >"), a company registered in the Philippines at Alpha Homes, Matina
          Aplaya, Davao City, Davao Del Sur 8000.
        </p>
        <p class="mt-4 text-sm text-justify">
          We operate the website
          <a href="https://hexabyt.com" class="text-blue-700 underline"
            >https://hexabyt.com</a
          >
          (the "<span class="font-semibold">Site</span>"), as well as any other
          related products and services that refer or link to these legal terms
          (the "Legal Terms") (collectively, the "Services").
        </p>
        <p class="mt-4 text-sm text-justify">
          HexaByt is a single platform that captures your business needs. It is
          also a open platform which can be integrated whatever your system your
          need. Meaning, our platform is growing whether surveying, real estate
          and many more. Discuss with us what you need to build apps that suites
          your business.
        </p>
        <p class="mt-4 text-sm text-justify">
          You can contact us by email at
          <span class="text-blue-700">info@hexabyt.com</span>, or by mail to
          Alpha Homes, Matina Aplaya, Davao City, Davao Del Sur 8000,
          Philippines.
        </p>
        <p class="mt-4 text-sm text-justify">
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ("<span
            class="font-semibold"
            >you</span
          >"), and HexaByt Software Development Service, concerning your access
        ...
        <p class="mt-4 text-sm text-justify">
          ...
          upon posting or notifying you by noreply@hexabyt.com, as stated in the
        ...
        <h1 class="mt-6 text-xl font-semibold">1. OUR SERVICES</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
            The information provided when using the Services is not intended for
            distribution toor use by any person or entity in any jurisdiction or
        ...
        <div>
          <h1 class="mt-4 text-lg font-semibold">Our intellectual property</h1>
          <p class="mt-4 text-sm text-justify">
          ...
          <p class="mt-4 text-sm text-justify">
            ...
            competition laws) and treaties in the Philippines and around the
            world.
          </p>
          <p class="mt-4 text-sm text-justify">
          ...
          <h1 class="mt-4 text-lg font-semibold">Your use of our Services</h1>
          <p class="mt-4 text-sm text-justify">
          ...
          <ul class="mx-8">
            <li>1. access the Services; and</li>
            <li>
          ...
          <p class="mt-4 text-sm text-justify">
            ...
            <span class="text-blue-700">info@hexabyt.com</span>. If we ever
            grant you the permission to post, reproduce, orpublicly display any
            ...
            copyrightor proprietary notice appears or is visible on posting,
            reproducing, or displaying ourContent.
          </p>
          <p class="mt-4 text-sm text-justify">
          ...
          <p class="mt-4 text-sm text-justify">
            ...
            material breach ofour Legal Terms and your right to use our Services
            will terminate immediately.
          </p>
          <h1 class="mt-4 text-lg font-semibold">Your submissions</h1>
          <p class="mt-4 text-sm text-justify">
          ...
          <p class="mt-4 text-sm text-justify">
            ...
            disseminationfor any lawful purpose, commercial or otherwise,
            without acknowledgment or compensation to you.
          </p>
        </div>

        <h1 class="mt-6 text-xl font-semibold">3. USER REPRESENTATIONS</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
            ...
            non-human means, whether through abot, script or otherwise; (6) you
        ...
        <h1 class="mt-6 text-xl font-semibold">4. USER REGISTRATION</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
        ...
        <h1 class="mt-6 text-xl font-semibold">5. PURCHASES AND PAYMENT</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
            We accept the following forms of payment:
          </p>
          <ul class="mt-2 ml-6 text-sm">
            <li>- Visa</li>
            <li>- Mastercard</li>
            <li>- Gcash</li>
            <li>- Paymaya</li>
          ...
          <p class="mt-4 text-sm text-justify">
            ...
            further agree to promptly update account, email address, and billing
            details, so that we can complete your transactions and contact you
            as needed. Sales tax will be added to the price of purchases as
            deemed required by us. We may change prices at any time. All
            payments shall be in Philippine Peso.
          </p>
          <p class="mt-4 text-sm text-justify">
            You agree to pay all charges at the prices then in effect for your
            purchases and any applicable transaction fees, and you authorize us
            ...
            then you consent to our charging your payment method on are curring
        ...
        <h1 class="mt-6 text-xl font-semibold">6. FREE TRIAL</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
        ...
        <h1 class="mt-6 text-xl font-semibold">7. CANCELLATION</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
            All purchases are non-refundable. Your subscription is active for
            the entirety of the cycle you chose and paid for (1 month or 1 year)
            and automatically ends afterwards; unless you pay for another cycle.
        ...
        <h1 class="mt-6 text-xl font-semibold">8. PROHIBITED ACTIVITIES</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
          ...
          <ul class="mt-2 ml-6 text-sm">
            ...
            <li class="mt-2">
              ...
              prevent or restrict the use or copying of anyContent or enforce
            ...
            <li class="mt-2">
              ...
              graphics interchange formats ("gifs"), 1×1pixels, web bugs,
            ...
            <li class="mt-2">
              ...
              in any way making up apart of the Services.
            </li>
            <li class="mt-2">
            ...
            <li class="mt-2">
              ...
              means for the purposeof sending unsolicited email, or creating
              user accounts by automated means orunder false pretenses.
            </li>
            <li class="mt-2">
            ...
            <li class="mt-2">- Sell or otherwise transfer your profile.</li>
          </ul>
        </div>
        ...
        <div>
          <p class="mt-4 text-sm text-justify">
            ...
            information, applications, software, and other contentor items
            ...
            endorsement thereofby us. If you decide to leave the Services and
            access the Third-Party Websites or touse or install any Third-Party
            Content, you do so at your own risk, and you should beaware these
            ...
            make through Third-Party Websites will be throughother websites and
        ...
        <h1 class="mt-6 text-xl font-semibold">10. SERVICES MANAGEMENT</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
        ...
        <h1 class="mt-6 text-xl font-semibold">11. PRIVACY POLICY</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
            ...
            Services are hosted in the Philippines. If you access the Services
            ...
            from applicable laws in the Philippines, then through your continued
            use of the Services, you are transferring your data to the
            Philippines, and you expressly consent to have your data transferred
            to and processed in the Philippines.
          </p>
        </div>

        <h1 class="mt-6 text-xl font-semibold">12. TERM AND TERMINATION</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
            ...
            CONTENT OR INFORMATION THAT YOU POSTED AT ANYTIME, WITHOUT WARNING,
        ...
        <div>
          <p class="mt-4 text-sm text-justify">
            ...
            the Services at anytime or for any reason at our sole discretion
            without notice. However, we have no obligation to update any
            information on our Services. We will not be liable to you or any
            third party for any modification, price change, suspension, or
            discontinuance ofthe Services.
          </p>
          <p class="mt-4 text-sm text-justify">
        ...
        <h1 class="mt-6 text-xl font-semibold">14. GOVERNING LAW</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
            These Legal Terms shall be governed by and defined following the
            laws of the Philippines. HexaByt Software Development Service and
            yourself irrevocably consent that the courts of the Philippines
            shall have exclusive jurisdiction to resolve any dispute which may
            arise in connection with these Legal Terms.
          </p>
        </div>

        <h1 class="mt-6 text-xl font-semibold">15. DISPUTE RESOLUTION</h1>
        <div>
          <h1 class="mt-4 text-lg font-semibold">Informal Negotiations</h1>
          <p class="mt-4 text-sm text-justify">
            ...
            those Disputesexpressly provided below) informally for at least
            sixty (60) days before initiating arbitration. Such informal
            negotiations commence upon written notice from one Partyto the other
            Party.
          </p>

          <h1 class="mt-4 text-lg font-semibold">Binding Arbitration</h1>
          <p class="mt-4 text-sm text-justify">
            ...
            arbitrators shall be two (2). The seat, or legal place,
            orarbitration shall be Davao City, Philippines. The language of the
            proceedings shall be English. The governing law of these Legal Terms
            shall be substantive law of the Philippines.
          </p>

          <h1 class="mt-4 text-lg font-semibold">Restrictions</h1>
          <p class="mt-4 text-sm text-justify">
        ...
        <h1 class="mt-6 text-xl font-semibold">16. CORRECTIONS</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
        ...
        <h1 class="mt-6 text-xl font-semibold">17. DISCLAIMER</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
            ...
            MISTAKES, OR INACCURACIES OF CONTENT ANDMATERIALS, (2) PERSONAL
            INJURY OR PROPERTY DAMAGE, OF ANY NATUREWHATSOEVER, RESULTING FROM
            YOUR ACCESS TO AND USE OF THESERVICES, (3) ANY UNAUTHORIZED ACCESS
            TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL
            INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN, (4) ANY
            INTERRUPTION ORCESSATION OF TRANSMISSION TO OR FROM THE SERVICES,
            ...
            ANYCONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE
        ...
        <h1 class="mt-6 text-xl font-semibold">18. LIMITATIONS OF LIABILITY</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
            ...
            POSSIBILITY OF SUCH DAMAGES. NOT WITHSTANDING ANYTHING TO THE
        ...
        <h1 class="mt-6 text-xl font-semibold">19. INDEMNIFICATION</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
            ...
            Services with whom you connected via the Services. Not withstanding
        ...
        <h1 class="mt-6 text-xl font-semibold">20. USER DATA</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
        ...
        <div>
          <p class="mt-4 text-sm text-justify">
            ...
            jurisdiction which require anoriginal signature or delivery or
            retention of non-electronic records, or to payments orthe granting
            of credits by any means other than electronic means.
          </p>
        </div>

        <h1 class="mt-6 text-xl font-semibold">22. MISCELLANEOUS</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
            ...
            aresult of these Legal Terms or use of the Services. You agree that
            ...
            of signing by the parties here to to execute these Legal Terms.
          </p>
        </div>

        <h1 class="mt-6 text-xl font-semibold">23. CONTACT US</h1>
        <div>
          <p class="mt-4 text-sm text-justify">
            In order to resolve a complaint regarding the Services or to receive
            further information regarding use of the Services, please contact us
            at <span class="text-blue-700">info@hexabyt.com</span>.
          </p>
        </div>
      </div>
    </div>
