  ...
  <div>
    <NuxtLayout name="admin" title="Surveys">
            ...
            >
              <template
                ...
                v-if="
                  !(
                    state.isPageLoading ||
                    (state.surveys.data && state.surveys.data.length === 0)
                  )
                "
              >
                <tr
                  v-for="(data, index) in state.surveys.data"
                  :key="index"
                  class="text-gray-700"
                >
                  ...
                  <td class="px-4 py-3">
                    <div class="flex items-center">
                      ...
                      >
                        <button
                          v-if="data.status != surveyStatus.cancelled"
      ...
      <ModalEmpty title="" :isShow="state.modalIsShowAttachment">
        <UiAttachment
          :typeID="15"
          :attachableID="state.selectedSurveyID"
