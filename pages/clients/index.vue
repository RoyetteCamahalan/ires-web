<template>
  <div>
    <NuxtLayout name="admin" title="Clients">
            ...
            >
              <template
                ...
                v-if="
                  !(
                    state.isPageLoading ||
                    (state.clients.data && state.clients.data.length === 0)
                  )
                "
              >
                <tr
                  v-for="(client, index) in state.clients.data"
                  :key="index"
                  class="text-gray-700"
                >
      ...
      >
        <UiClientForm
          @modalClose="modalClose"
          :formStatusEdit="state.formStatusEdit"
